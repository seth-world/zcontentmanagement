...
/* here after : uncomment to have stack follow-up and dump in case of error */
//#define __ERROR_MANAGEMENT_LEVEL__  2
...
#include <znet/zconfig_network.h>
